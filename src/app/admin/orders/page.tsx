...
export default async function AdminOrdersPage() {
  ...
  const serializedOrders = orders.map((order) => ({
    ...
    items: order.items.map((item) => ({
      ...
      giftCardRecipientName: item.giftCardRecipientName ?? null,
      giftCardRecipientEmail: item.giftCardRecipientEmail ?? null,
      giftCardSenderName: item.giftCardSenderName ?? null,
      giftCardMessage: item.giftCardMessage ?? null,
